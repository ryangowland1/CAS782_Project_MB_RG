...
Write-Host "================================================================="
Write-Host ""
Write-Host "Follow the Quick Start guide for detailed instructions:"
Write-Host ""
Write-Host "   See QUICKSTART.md"
Write-Host ""
Write-Host "This guide includes all setup, activation, and usage commands."
Write-Host ""

Write-Host "================================================================="
Write-Host ""
Write-Host "Questions? See PREREQUISITES.md"
Write-Host ""
